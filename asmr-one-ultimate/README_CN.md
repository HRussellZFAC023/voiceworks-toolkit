...
#### 音频缓存 — 离线播放
基于 IndexedDB 的音频缓存，支持 TTL 过期。播放时自动缓存音轨，供离线回放和减少带宽使用。

### 媒体与可视化

#### 媒体查看器 — 内联画廊
支持图片和视频的点击展开灯箱。支持 JPG、PNG、GIF、WebP、MP4、WebM、MOV、PDF 等格式。幻灯片模式，键盘和滑动导航。

#### 播放器画廊 — 专辑封面浏览
集成于播放器封面区域的图片画廊，支持幻灯片导航、箭头控件和键盘快捷键。
